// ft-ui.js — v2.0
// REGRA CRÍTICA: abrirModal() injeta HTML de forma SÍNCRONA.
// NUNCA usar "await abrirModal()" — adicione listeners logo após a chamada.
...
export function toast(msg, tipo = 'info') {
  ...
  setTimeout(() => { el.classList.remove('on'); setTimeout(() => el.remove(), 350); }, 3300);
}
